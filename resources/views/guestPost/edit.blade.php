        ...
        <div class="col-lg-6 m-auto">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('guest/post/view')}}">Guest Post list</a></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('add/guest/post/move')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{ asset('uploads/guestPostImages')}}/{{$singlePostInfo->post_image }}"
                                alt="image not found" width="500" class="img-fluid pt-3">
                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn btn-warning">পোস্ট করুন </button>
                        </div>
                </div>
                </form>
            </div>
